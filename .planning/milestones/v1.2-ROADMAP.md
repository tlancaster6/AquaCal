...
Transform AquaCal from a working calibration library into a pip-installable PyPI package with comprehensive documentation, example datasets, Jupyter tutorials, and automated CI/CD. This roadmap delivers the v1.2 public release by following scientific Python community standards: Sphinx documentation on Read the Docs, GitHub Actions testing across Python 3.10-3.12, example notebooks demonstrating end-to-end workflows, and Trusted Publishing for secure PyPI releases.
