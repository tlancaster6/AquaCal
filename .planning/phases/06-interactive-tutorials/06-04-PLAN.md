  ...
  <action>
    ...
    **Cell structure:**
    ...
    5. **Parameter Convergence** (markdown + code):
       ...
       - **Warning callout**: "If interface distance diverges or oscillates, the initial estimate may be too far from truth. Try providing explicit initial_water_z in config."
